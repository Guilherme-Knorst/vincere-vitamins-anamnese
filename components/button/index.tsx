...
export default function Button({ small, isInputConfirm, ...props }: ButtonProps) {
	return (
		<div
			className={`transition-all duration-500 ease-in-out flex justify-center drop-shadow-[1px_1px_35px_rgba(27,233,205,0.25)] text-black bg-gradient-to-r from-primary to-secondary font-semibold uppercase chanfro-btn w-[370px] ${
		...
		>
			<button
				...
				}  w-full p-4 disabled:bg-slate-500 tracking-wider text-2xl`}
				type='button'
				{...props}
			>
				{props.children}
